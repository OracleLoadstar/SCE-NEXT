...
namespace winrt::App2::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES MainWindow_base : implements<D, App2::MainWindow, composing, I...>,
        ...
        impl::base<D, winrt::Microsoft::UI::Xaml::Window>
    {
        ...
        using class_type = App2::MainWindow;
...
namespace winrt::App2::factory_implementation
{
    ...
    {
        using instance_type = App2::MainWindow;
