...
namespace winrt::App2::implementation
{
    ...
    struct HomeT : public ::winrt::App2::implementation::Home_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename HomeT::base_type;
        using base_type::base_type;
        using class_type = typename HomeT::class_type;
