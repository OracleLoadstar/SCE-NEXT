...
namespace winrt::App2::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Setting_base : implements<D, App2::Setting, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Setting_base;
        using class_type = App2::Setting;
        using implements_type = typename Setting_base::implements_type;
...
namespace winrt::App2::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES SettingT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = App2::Setting;
...
#if defined(WINRT_FORCE_INCLUDE_SETTING_XAML_G_H) || __has_include("Setting.xaml.g.h")

#include "Setting.xaml.g.h"
...
{
    template <typename D, typename... I>
    using SettingT = Setting_base<D, I...>;
}
