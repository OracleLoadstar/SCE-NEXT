...
namespace winrt::App2::implementation
{
    ...
    struct Calculator_pgT : public ::winrt::App2::implementation::Calculator_pg_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename Calculator_pgT::base_type;
        using base_type::base_type;
        using class_type = typename Calculator_pgT::class_type;
    ...
    private:
        struct Calculator_pg_obj1_Bindings;
