...
namespace winrt::App2::implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES Home_base : implements<D, App2::Home, composing, winrt::Microsoft::UI::Xaml::Controls::IPageOverrides, winrt::Microsoft::UI::Xaml::Controls::IControlOverrides, winrt::Microsoft::UI::Xaml::IFrameworkElementOverrides, winrt::Microsoft::UI::Xaml::IUIElementOverrides, I...>,
    ...
    {
        using base_type = Home_base;
        using class_type = App2::Home;
        using implements_type = typename Home_base::implements_type;
...
namespace winrt::App2::factory_implementation
{
    ...
    struct WINRT_IMPL_EMPTY_BASES HomeT : implements<D, winrt::Windows::Foundation::IActivationFactory, I...>
    {
        using instance_type = App2::Home;
...
#if defined(WINRT_FORCE_INCLUDE_HOME_XAML_G_H) || __has_include("Home.xaml.g.h")

#include "Home.xaml.g.h"
