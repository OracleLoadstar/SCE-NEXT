...
namespace winrt::App2::implementation
{
    ...
    struct ResuitT : public ::winrt::App2::implementation::Resuit_base<D,
        ::winrt::Microsoft::UI::Xaml::Markup::IComponentConnector,
        I...>
    {
        using base_type = typename ResuitT::base_type;
        using base_type::base_type;
        using class_type = typename ResuitT::class_type;
